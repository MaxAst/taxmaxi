/**
 * FactualLedgerSnapshotReader - Drizzle-backed factual-ledger adapter.
 *
 * @module FactualLedgerSnapshotReader
 */
...
/** Build the shared factual snapshot reader; callers supply the ambient read transaction. */
export const makeFactualLedgerSnapshotReader = Effect.gen(function* () {
