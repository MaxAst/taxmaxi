...
ALTER TABLE "calculation_sync_requests" ADD CONSTRAINT "calculation_sync_requests_job_owner_fk" FOREIGN KEY ("source_job_id","source_id","principal_id") REFERENCES "processing_jobs"("id","source_id","principal_id");--> statement-breakpoint
ALTER TABLE "calculation_sync_requests" ADD CONSTRAINT "calculation_sync_requests_source_owner_fk" FOREIGN KEY ("source_id","principal_id") REFERENCES "sources"("id","principal_id");